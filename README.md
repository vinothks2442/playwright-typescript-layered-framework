...
This project demonstrates how a Playwright automation framework can be structured for maintainability, reusability, and clear separation of responsibilities.
...
- **14 unique automated test scenarios**
- **42 total executions across Chromium, Firefox, and WebKit**
